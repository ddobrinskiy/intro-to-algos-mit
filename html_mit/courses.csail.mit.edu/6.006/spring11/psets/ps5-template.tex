...
\answer{1 -- Arbitrage}{INSERT COLLABORATORS HERE} 
%Write `none' if solved alone.

\answer{2 -- Negative Weight Edges}{INSERT COLLABORATORS HERE}
%Write `none' if solved alone.

\answer{3 -- Integer Weights}{INSERT COLLABORATORS HERE}
%Write `none' if solved alone.

\answer{4 -- Speeding Up Dijkstra}{INSERT COLLABORATORS HERE}
%Write `none' if solved alone.
