...
\answer{1 -- Placing Parentheses}{INSERT COLLABORATORS HERE} 
%Write `none' if solved alone.

\answer{2 -- Text Formatting}{INSERT COLLABORATORS HERE}
%Write `none' if solved alone.

\answer{3 -- Dungeons and Dragons and Dynamic Programming}{INSERT COLLABORATORS HERE}
%Write `none' if solved alone.

\answer{4 -- Railroads and Gauges}{INSERT COLLABORATORS HERE}
%Write `none' if solved alone.
